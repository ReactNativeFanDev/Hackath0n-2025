...
export const AuthorizationLoginScreen: React.FC = () => {
  const {
  ...
  return (
    <View onTouchStart={() => Keyboard.dismiss()} style={styles.container}>
      ...
      <Text style={styles.title}>{'Зробимо світ'}</Text>
      <Text style={styles.title}>{'краще!'}</Text>
      ...
      <Pressable
        onPress={() => emailAndPasswordSignIn(email, password)}
        style={({pressed}) => [
      ...
      <View style={styles.singUpButtonContainer}>
        ...
        <Pressable
          ...
          <Text style={styles.forgotPasswordFocusedText}>Sign Up</Text>
        </Pressable>
      </View>
    </View>
  );
